...
Elm.Kelmote = Elm.Kelmote || {};
Elm.Kelmote.make = function (_elm) {
   "use strict";
   _elm.Kelmote = _elm.Kelmote || {};
   if (_elm.Kelmote.values)
   return _elm.Kelmote.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Kelmote$Inner = Elm.Kelmote.Inner.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var fromMD = function (mdStr) {
      ...
      _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                        ...
                                                        ,{ctor: "_Tuple2"
                                                         ,_0: "padding"
                                                         ,_1: "5px"}]))]),
      _L.fromArray([A2($Markdown.toHtmlWith,
      $Markdown.defaultOptions,
      mdStr)])));
   };
   var swing = F2(function (t,e) {
      return function () {
         var w = $Graphics$Element.widthOf(e);
         var h = $Basics.round($Basics.toFloat($Graphics$Element.widthOf(e)) * 2.0) + $Graphics$Element.heightOf(e);
         return A3($Graphics$Collage.collage,
         w,
         h,
         _L.fromArray([A2($Graphics$Collage.rotate,
         $Basics.sin(t / 250) * 0.2,
         $Graphics$Collage.toForm(e))]));
      }();
   });
   var rotateEasing = A2($Easing.cycle,
   A4($Easing.ease,
   $Easing.linear,
   $Easing.$float,
   0,
   9),
   $Time.second);
   var blink = F2(function (t,e) {
      return function () {
         var o = $Basics.toFloat(A2($Basics._op["%"],
         $Basics.round(rotateEasing(t)),
         10)) / 10;
   ...
   var scale = F2(function (t,e) {
      return function () {
         var x = $Basics.toFloat(A2($Basics._op["%"],
         $Basics.round(rotateEasing(t)),
         10)) / 10 + 1;
         return A3($Graphics$Collage.collage,
         $Basics.ceiling($Basics.toFloat($Graphics$Element.widthOf(e)) * x),
         $Basics.ceiling($Basics.toFloat($Graphics$Element.heightOf(e)) * x),
         _L.fromArray([A2($Graphics$Collage.scale,
         x,
         $Graphics$Collage.toForm(e))]));
      }();
   });
   var run = function (pageList) {
      return A2($Signal._op["~"],
      A2($Signal._op["~"],
      A2($Signal._op["<~"],
      $Kelmote$Inner.view(pageList),
      $Window.dimensions),
      $Kelmote$Inner.pageCount),
      A3($Signal.foldp,
      F2(function (x,y) {
         return x + y;
      }),
   ...
   var defaultTextStyle = {_: {}
                          ...
                          ,italic: false
                          ,line: $Maybe.Nothing
                          ,typeface: _L.fromArray(["Lucida Console"
                                                  ,"monospace"])};
   var bgImage = $Kelmote$Inner.BGImage;
   var bgColor = $Kelmote$Inner.BGColor;
   var page = F3(function (header,
   content,
   background) {
      return A3($Kelmote$Inner.Page$,
      header,
      content,
      background);
   });
   var rotation = F2(function (angl,
   e) {
      return function () {
         var w = $Graphics$Element.widthOf(e);
         var h = $Basics.round($Basics.toFloat($Graphics$Element.widthOf(e)) * $Basics.sin($Basics.degrees(angl))) + $Graphics$Element.heightOf(e);
         return A3($Graphics$Collage.collage,
         w,
         h,
         _L.fromArray([A2($Graphics$Collage.rotate,
   ...
   var texts = function (styl) {
      return function ($) {
         return $Graphics$Element.flow($Graphics$Element.down)($List.map($Kelmote$Inner.strToContent(styl))($));
      };
   };
   var h_ = $Kelmote$Inner.strToHeader;
   _elm.Kelmote.values = {_op: _op
                         ,h_: h_
                         ,texts: texts
                         ,v2L: v2L
                         ,h2L: h2L
...
Elm.Kelmote = Elm.Kelmote || {};
Elm.Kelmote.Inner = Elm.Kelmote.Inner || {};
Elm.Kelmote.Inner.make = function (_elm) {
   "use strict";
   _elm.Kelmote = _elm.Kelmote || {};
   _elm.Kelmote.Inner = _elm.Kelmote.Inner || {};
   if (_elm.Kelmote.Inner.values)
   return _elm.Kelmote.Inner.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Kelmote.Inner",
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   ...
   var BGImage = function (a) {
      return {ctor: "BGImage"
             ,_0: a};
   };
   var BGColor = function (a) {
      return {ctor: "BGColor"
             ,_0: a};
   };
   var bg = F4(function (w,h,b,e) {
      return function () {
         switch (b.ctor)
         {case "BGColor":
            return A2($Graphics$Element.color,
              ...
              e);
            case "BGImage":
            return $Graphics$Element.layers(_L.fromArray([A3($Graphics$Element.fittedImage,
                                                         w,
                                                         h,
                                                         b._0)
                                                         ,e]));}
   ...
   var pageByIdx = F2(function (idx,
   pList) {
      return function () {
         var _v3 = A2($Array.get,
         idx,
         $Array.fromList(pList));
         switch (_v3.ctor)
         {case "Just": return _v3._0;
            case "Nothing": return A3(Page$,
              function (t) {
   ...
   sec) {
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 var page = A2(pageByIdx,
                 currentPage,
                 pageList);
                 var header = function (t) {
                    return A4($Graphics$Element.container,
                    _v5._0,
                    $Graphics$Element.heightOf(page.header(t)) + 20,
                 ...
                 _v5._0,
                 _v5._1,
                 page.background)($Graphics$Element.layers(_L.fromArray([header(sec)
                                                                        ,content(sec)])));
              }();}
         _U.badCase($moduleName,
   ...
   var pageCount = function () {
      var arrowSignal = A2($Signal._op["<~"],
      function (_) {
         return _.x;
      },
      $Keyboard.arrows);
      var tapSignal = A2($Signal._op["~"],
      A2($Signal._op["<~"],
      F2(function (_v9,_v10) {
         return function () {
            return function () {
               switch (_v9.ctor)
               {case "_Tuple2":
                  return _U.cmp(_v10.x,
                    $Basics.round($Basics.toFloat(_v9._0) * 3 / 4)) > -1 ? 1 : _U.cmp(_v10.x,
                    $Basics.round($Basics.toFloat(_v9._0) / 4)) < 1 ? -1 : 0;}
               _U.badCase($moduleName,
   ...
   var X = F2(function (a,b) {
      return {_: {},x: a,y: b};
   });
   var strToHeader = function (styl) {
      return function ($) {
         return $Text.leftAligned($Text.style(styl)($Text.fromString($)));
      };
   };
   var strToContent = function (styl) {
      return function ($) {
         return $Text.centered($Text.style(styl)($Text.fromString($)));
      };
   };
   _elm.Kelmote.Inner.values = {_op: _op
                               ,strToContent: strToContent
                               ,strToHeader: strToHeader
                               ,X: X
                               ,pageCount: pageCount
                               ,pageByIdx: pageByIdx
                               ,view: view
...
Elm.Sample.make = function (_elm) {
   ...
   if (_elm.Sample.values)
   return _elm.Sample.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var mdcode = $Kelmote.fromMD(codeSample);
   var emptyElement = function (t) {
      return $Graphics$Element.empty;
   };
   var page$ = A3($Kelmote.page,
   emptyElement,
   emptyElement,
   $Kelmote.bgColor($Color.blue));
   var img3 = A3($Graphics$Element.fittedImage,
   400,
   400,
   "Example/IMG_1127.jpg");
   var img2 = A3($Graphics$Element.fittedImage,
   400,
   400,
   "Example/IMG_0638.jpg");
   var img1 = A3($Graphics$Element.fittedImage,
   400,
   400,
   "Example/IMG_1448.jpg");
   var styl3 = _U.replace([["color"
                           ,$Color.lightBlue]],
   $Kelmote.defaultTextStyle);
   var styl2 = _U.replace([["color"
                           ,$Color.yellow]],
   $Kelmote.defaultTextStyle);
   var styl4 = _U.replace([["height"
                           ,$Maybe.Just(100)]],
   styl2);
   var styl1 = _U.replace([["color"
                           ,$Color.white]
                          ,["height",$Maybe.Just(70)]],
   $Kelmote.defaultTextStyle);
   var header2 = function (t) {
      return A2($Kelmote.h_,
      styl1,
      "Elmとは?");
   };
   var simple = F3(function (h,
   cStyle,
   c) {
   ...
   rightE) {
      return _U.replace([["header"
                        ...
                        ,["content"
                         ,function (t) {
                            return A2($Kelmote.v2L,
                            leftE,
                            rightE);
                         }]],
      page$);
   });
   var h2 = F3(function (h,
   upperE,
   lowerE) {
      return _U.replace([["header"
                         ,function (_v6) {
                        ...
                        ,["content"
                         ,function (t) {
                            return A2($Kelmote.h2L,
                            upperE,
                            lowerE);
                         }]],
      page$);
   });
   var pageList = _L.fromArray([A3(simple,
                               "",
                               styl1,
                               _L.fromArray(["Kelmote"]))
                               ,A3(simple,
                               "",
                               styl2,
                               _L.fromArray(["最近 Elm を触っています"]))
                               ,A3(simple,
                               "",
                               styl4,
                               _L.fromArray(["Elm?"]))
                               ...
                               _L.fromArray(["Haskellっぽい感じ？"
                                            ,"コールバック地獄から抜け出せる？"
                                            ,"ちょっと違うか？HTMLやCSSも出力する"])))
                               ,A3(simple,
                               "",
                               styl2,
                               _L.fromArray(["そのElmでスライドツール作ってみました"]))
                               ,A3(simple,
                               "",
                               _U.replace([["height"
                                           ,$Maybe.Just(80)]],
                               ...
                               "",
                               styl3,
                               _L.fromArray(["文字色変えたり"]))
                               ,A3($Kelmote.page,
                               emptyElement,
                               function (t) {
                                  return A2($Kelmote.blink,
                                  t,
                                  A2($Kelmote.h2L,
                                  A2($Kelmote.texts,
                                  styl2,
                               ...
                               _U.replace([["height"
                                           ,$Maybe.Just(100)]],
                               styl2),
                               _L.fromArray(["文字サイズ変えたり"]))
                               ,A3($Kelmote.page,
                               emptyElement,
                               function (t) {
                                  return A2($Kelmote.scale,
                                  t,
                                  A2($Kelmote.texts,
                                  styl2,
                                  _L.fromArray(["ボワンボワンさせたり"])));
                               },
                               $Kelmote.bgColor($Color.blue))
                               ,A3($Kelmote.page,
                               emptyElement,
                               function (t) {
                                  return $Kelmote.rotation(30)(A2($Kelmote.texts,
                                  styl2,
                                  _L.fromArray(["傾かせたり"])));
                               },
                               $Kelmote.bgColor($Color.blue))
                               ...
                               emptyElement,
                               function (t) {
                                  return $Kelmote.swing(t)(A2($Kelmote.texts,
                                  styl2,
                                  _L.fromArray(["ゆらゆらさせたり"])));
                               },
                               $Kelmote.bgColor($Color.blue))
                               ,function () {
                                  var p = A3(simple,
                                  "",
                                  styl2,
                                  _L.fromArray(["背景色変えたり"]));
                                  return _U.replace([["background"
                                                     ,$Kelmote.bgColor($Color.red)]],
                                  p);
                               }()
                               ,A3($Kelmote.page,
                               emptyElement,
                               function (t) {
                                  return function () {
                                     var c1 = A2($Kelmote.texts,
                                     _U.replace([["color"
                                                 ,$Color.white]],
                                     styl2),
                                     _L.fromArray(["背景画像設定したり"]));
                                     return A2($Graphics$Element.opacity,
                                     0.8,
                               ...
                               $Kelmote.bgImage("Example/IMG_0064.JPG"))
                               ,A3(h2,
                               "",
                               A2($Kelmote.texts,
                               styl2,
                               _L.fromArray(["コードを貼ったり"])),
                               mdcode)
                               ,A3(simple,
                               "",
                               styl2,
                               _L.fromArray(["今のところそんな感じです"]))]);
   var main = $Kelmote.run(pageList);
   _elm.Sample.values = {_op: _op
                        ,styl1: styl1
                        ,styl2: styl2
                        ,styl3: styl3
                        ,styl4: styl4
